...
class Scene2(Scene):
    def construct(self):
        ...
        self.play(
            theta_tracker.animate.set_value(ang_freq * 3.5),
            run_time=3.5,
            rate_func=linear
        )
        theta = theta_tracker.get_value()
        ...
        self.play(
            theta_tracker.animate.set_value(theta + ang_freq * 0.5),
            Create(shm1),
            Create(shm2),
            Create(label1),
            Create(label2),
        ...
        self.play(
            theta_tracker.animate.set_value(theta + ang_freq * 3.5),
            run_time=3.5,
            rate_func=linear
        )
        theta = theta_tracker.get_value()
        ...
        self.play(
            theta_tracker.animate.set_value(theta + ang_freq * 4.5),
            run_time=4.5,
            rate_func=linear
        )
        theta = theta_tracker.get_value()
        ...
        self.play(
            theta_tracker.animate.set_value(theta + ang_freq * 1),
            Create(shm3),
            FadeIn(label1),
            FadeIn(label2),
            run_time=1,
        ...
        self.play(
            theta_tracker.animate.set_value(theta + ang_freq * 1.5),
            run_time=1.5,
            rate_func=linear
        )
        ...
        self.play(
            theta_tracker.animate.set_value(theta + ang_freq * 6.5),
            run_time= 6.5,
            rate_func=linear
        )
        theta = theta_tracker.get_value()
